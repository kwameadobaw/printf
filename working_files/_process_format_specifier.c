		...
		int *printed_chars)
{
	...
	switch (**format)
	{
		...
		case 'b':
			...
			break;
		case 'u':
			chars_written += _print_u(args, buffer, &chars_written);
			(*printed_chars) += chars_written;
			break;
		case 'o':
			chars_written += _print_o(args, buffer, &chars_written);
			(*printed_chars) += chars_written;
			break;
		case 'x':
			chars_written += _print_hex_lo(args, buffer, &chars_written);
			(*printed_chars) += chars_written;
			break;
		case 'X':
			chars_written += _print_hex_up(args, buffer, &chars_written);
			(*printed_chars) += chars_written;
			break;
